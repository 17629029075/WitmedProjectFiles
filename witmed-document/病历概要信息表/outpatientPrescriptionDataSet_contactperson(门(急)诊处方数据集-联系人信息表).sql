drop table if exists outpatientPrescriptionDataSet_contactperson;
create table outpatientPrescriptionDataSet_contactperson(
	...
	primary key(id)
)engine=Innodb charset=utf8mb4 comment='(门(急)诊处方数据集-联系人信息表';