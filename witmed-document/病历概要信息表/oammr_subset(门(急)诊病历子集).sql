drop table if exists oammr_subset;
create table oammr_subset(
	...
	chiefComplaint varchar(100) comment '主诉',
	nameSymptomCodeCodingSystem varchar(100) comment '症状代码编码体系名称',
	symptomCode varchar(100) comment '症状代码',
	symptomStartDate datetime comment '症状开始日期时间',
	symptomStopDate datetime comment '症状停止日期时间',
	symptomDescription varchar(100) comment '症状描述',
	symptomAcuityCode varchar(100) comment '症状急性程度代码',
	severityCode varchar(100) comment '严重程度代码',
	initialDiagnosisMark int(10) comment '初诊标志',
	...
	observationResultNumerical varchar(100) comment '观察-结果(数值)',
	observationUnitMeasure varchar(100) comment '观察-计量单位',
	observationResultCode varchar(100) comment '观察-结果代码',

	onsetTime datetime comment '起病时间',
	onsetSolarTermsCode varchar(100) comment '起病节气归属代码',
	onsetDescription varchar(100) comment '起病情况描述',
	symptomCause varchar(100) comment '症状开始原因/诱因',
	symptomCharacteristics varchar(100) comment '症状特点',
	accompanyingSymptoms varchar(100) comment '伴随症状',
	symptomsPast varchar(100) comment '本疾病既往诊疗经过',
	onsetConditions varchar(100) comment '起病后一般情况',
	diagnosisAndTreatmentOfBasicDiseases varchar(100) comment '基础疾病诊疗情况',

	previousObservationProjectName varchar(100) comment '既往观察-项目名称',
	pastObservationItemClassificationCode varchar(100) comment '既往观察-项目分类代码',
	previousObservationProjectCodeName varchar(100) comment '既往观察-项目代码名称',
	previousObservationProjectCode varchar(100) comment '既往观察-项目代码',
	previousObservationMethodCode varchar(100) comment '既往观察-方法代码',
	previousObservationResults varchar(100) comment '既往观察-结果',
	categoryNameOfPreviousHistoryObservationItems varchar(100) comment '既往史观察项目类目名称',
	previousHistoricalObservations varchar(100) comment '既往史观察结果',

	allergicHistory varchar(100) comment '过敏史',
	allergen varchar(100) comment '过敏原',
	allergicSymptoms varchar(100) comment '过敏症状',
	allergySymptomCode varchar(100) comment '过敏症状代码',
	allergenCode varchar(100) comment '过敏原代码',
	allergicDrugName varchar(100) comment '过敏药物名称',
	allergyConditionStatusCode varchar(100) comment '过敏病情状态代码',
	allergySeverityCode varchar(100) comment '过敏严重性代码',
	allergyHistoryIdentificationCode varchar(100) comment '过敏史标识代码',
	...
	proposedInspection varchar(100) comment '拟做的检查',
	proposedMedicalExamination datetime comment '拟做的医学检验',
	futureTreatmenOptions varchar(100) comment '今后治疗方案',
	followUpsign int(10) comment '随访标志',
	followUpInterval  varchar(100) comment '随访间隔（随诊期限）',
	doctorsOrder varchar(100) comment '医嘱',
	specialPrecautions varchar(100) comment '特别注意事项',

	treatmentProcessName varchar(100) comment '诊疗过程名称',
	treatmentProcessDescription varchar(100) comment '诊疗过程描述',
	
	doctorsOrderStartTime datetime comment '医嘱开嘱日期时间',
	doctorsOrderStopTime datetime comment '长期医嘱停嘱日期时间',
	doctorsOrderImplementTime datetime comment '医嘱执行日期时间',
	doctorsOrderImplementTimeCategoryCode varchar(100) comment '医嘱执行时间类别代码',
	doctorsOrderCancelTime datetime comment '医嘱取消日期时间',
	doctorsOrderCategory varchar(100) comment '医嘱类别',
	orderableContent varchar(100) comment '医嘱内容',
	...
	primary key(id)
)engine=Innodb charset=utf8mb4 comment='门(急)诊病历子集信息表';